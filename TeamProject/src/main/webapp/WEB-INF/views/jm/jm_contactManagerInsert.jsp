		...
		<div class="col-md-12">
			...
			<form   role="form" action="/jm/jm_contactManagerInsertRun" method="post">
				...
				<div class="form-group">
					...
					<input type="hidden" class="form-control" id="c_originnum" name="c_originnum" value="${origin}" />
				</div>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="c_subject" name="c_subject" value="ㄴRe:" required  />
				</div>
