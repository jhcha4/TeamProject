...
public class LshBoardDto {
	...
	public String toString() {
		return "LshBoardDto [priceType=" + priceType + ", page=" + page + ", perPage=" + perPage + ", startRow="
				+ startRow + ", endRow=" + endRow + ", totalCount=" + totalCount + ", totalPage=" + totalPage
				+ ", startPage=" + startPage + ", endPage=" + endPage + ", PAGE_BOLOCK=" + PAGE_BOLOCK + ", p_main="
				+ p_main + ", p_serve=" + p_serve + "]";
	}
